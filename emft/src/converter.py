...
def fix_latex_glitches(text):
    ...
    # Fix EMFT vector notation & common symbols
    text = text.replace('a_x', '\\hat{a}_x').replace('a_y', '\\hat{a}_y').replace('a_z', '\\hat{a}_z')
    text = text.replace('a_r', '\\hat{a}_r').replace('a_{\\phi}', '\\hat{a}_{\\phi}').replace('a_{\\theta}', '\\hat{a}_{\\theta}')
    text = text.replace('a_\\phi', '\\hat{a}_\\phi').replace('a_\\theta', '\\hat{a}_\\theta')
    ...
    # Fix double/extra closing braces in \text{...}} or \text{...}}
...
def clean_html_to_latex(html_element, image_map):
    ...
    greek_symbols = [
        r'\\rho', r'\\theta', r'\\phi', r'\\pi', r'\\alpha', r'\\beta',
        r'\\gamma', r'\\mu', r'\\epsilon', r'\\sigma', r'\\lambda', r'\\omega',
        r'\\Omega', r'\\times'
    ]
