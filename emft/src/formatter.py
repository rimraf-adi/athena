...
def get_clean_topic_and_year(tags):
    year_str = ""
    topic_str = r"Electromagnetics \& Transmission Lines"
    ...
    for t in tags:
        ...
        if "GATE" in t_clean.upper() or "SET" in t_clean.upper() or any(y in t_clean for y in ["2026","2025","2024","2023","2022","2021","2020","2019","2018","2017","2016","2015","2014","2013","2012","2011","2010","2009","2008","2007","2006","2005","2004","2003","2002","2001"]):
            ...
            if "basics" in t_lower or "maxwell" in t_lower or "electrostatic" in t_lower or "magnetostatic" in t_lower:
                topic_str = r"Basics of Electromagnetics \& Maxwell's Eqns"
            elif "transmission" in t_lower or "smith" in t_lower:
                topic_str = "Transmission Lines"
            elif "uniform" in t_lower or "plane wave" in t_lower or "wave propagation" in t_lower:
                topic_str = "Uniform Plane Waves"
            elif "waveguide" in t_lower or "mode" in t_lower or "fiber" in t_lower:
                topic_str = "Waveguides \& Optical Fibers"
            elif "antenna" in t_lower or "radiation" in t_lower or "dipole" in t_lower:
                topic_str = r"Antennas \& Radiating Systems"
            else:
...
def append_raw_questions_step1(questions, output_path):
    print("Step 1: Appending each scraped EMFT question raw first...")
    with open(output_path, "w", encoding="utf-8") as f:
        f.write("% --- RAW SCRAPED EMFT QUESTIONS (APPENDED FIRST) ---\n\n")
        for idx, q in enumerate(questions, 1):
            ...
            f.write("-" * 80 + "\n\n")
    print(f"Step 1 complete! Raw EMFT questions written to {output_path}.")

def format_latex_step2(questions, image_map, output_path):
    print("Step 2: Formatting LaTeX properly for EMFT...")
