...
CS_KEYWORDS = [
    "control systems", "block diagram", "signal flow graph", "sfg", "mason",
    "time response", "transient", "steady state", "stability", "routh", "hurwitz",
    "root locus", "bode plot", "nyquist", "polar plot", "gain margin", "phase margin",
    "compensator", "controller", "lead", "lag", "pid", "state space", "controllability", "observability"
]
...
async def collect_all_questions():
    async with httpx.AsyncClient(headers=HEADERS, follow_redirects=True, timeout=15.0) as client:
        primary_url = 'https://practicepaper.in/gate-ec/control-systems'
        ...
        print(f"Total unique Control Systems questions collected: {len(all_qs)}")
