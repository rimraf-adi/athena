...
\title{\Huge\bfseries GATE EC: Signals and Systems\\[0.3em] \Large Previous Year Solved Questions (238 Questions)}
...
def get_clean_topic_and_year(tags):
    ...
    for t in tags:
        ...
        if "GATE" in t_clean.upper() or "SET" in t_clean.upper() or any(y in t_clean for y in ["2026","2025","2024","2023","2022","2021","2020","2019","2018","2017","2016","2015","2014","2013","2012","2011","2010","2009","2008","2007","2006","2005","2004","2003","2002","2001"]):
            ...
            if "basics" in t_lower:
                topic_str = r"Basics of Signals \& Systems"
            elif "lti" in t_lower:
                topic_str = "LTI Systems"
            elif "fourier transform" in t_lower or "frequency response" in t_lower or "correlation" in t_lower:
                topic_str = "Fourier Transforms"
            elif "fourier series" in t_lower:
                topic_str = "Fourier Series"
            elif "laplace" in t_lower:
                topic_str = "Laplace Transform"
            elif "z-transform" in t_lower or "z transform" in t_lower:
                topic_str = "Z-Transform"
            elif "sampling" in t_lower:
                topic_str = "Sampling"
            elif "dtfs" in t_lower or "dtft" in t_lower or "dft" in t_lower:
                topic_str = r"DTFS, DTFT \& DFT"
            elif "filter" in t_lower:
                topic_str = "Digital Filters"
            else:
